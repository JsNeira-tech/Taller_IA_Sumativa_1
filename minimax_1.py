...
def minimax(tabla_juego, prof, max_jugador, num_filas, num_columnas, nodos_explorados=0):
    nodos_explorados += 1
    ...
    if max_jugador:
        ...
        for col in pos_valida:
            ...
            _, nuevo_puntaje, nodos_explorados = minimax(temp_tabla_juego, prof - 1, False, num_filas, num_columnas, nodos_explorados)
        ...
        for col in pos_valida:
            ...
            _, nuevo_puntaje, nodos_explorados = minimax(temp_tabla_juego, prof - 1, True, num_filas, num_columnas, nodos_explorados)
            if nuevo_puntaje < valor:
                valor = nuevo_puntaje
                columna = col
        return columna, valor, nodos_explorados
